        ...
        return (
            <div className="row div_title_slide">
                ...
                <nav id="nav_head_3" className="nav flex-column container">
                    <Link to="/shopcun" className="nav-item nav-link" href="#"><span className="desk" style={{display: 'none'}}>SHOP CHO CÚN</span><i className="fas fa-dog fa-2x mb" /></Link>
                    <Link to="/shopmeo" className="nav-item nav-link" href="#"><span className="desk" style={{display: 'none'}}>SHOP CHO MÈO</span><i className="fas fa-cat fa-2x mb" /></Link>
                    <Link to="/giamgia" className="nav-item nav-link" href="#"><span className="desk" style={{display: 'none'}}>KHUYẾN MẠI</span><i className="fas fa-percent fa-2x mb" /></Link>
                    <Link to="/tintuc" className="nav-item nav-link" href="#"><span className="desk" style={{display: 'none'}}>TIN TỨC</span><i className="fas fa-newspaper fa-2x mb" /></Link>
